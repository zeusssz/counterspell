export default function Schedule() {
  const schedule = [
    { time: "12:00 PM", event: "Doors open" },
    { time: "12:10 PM", event: "Opening ceremony" },
    { time: "12:30 PM", event: "Gamedev workshop 1" },
    { time: "1:00 PM", event: "Start working on your game!" },
    { time: "6:30 PM", event: "Dinner" },
    { time: "7:00 PM", event: "Activity 1" },
    { time: "9:00 PM", event: "Gamedev workshop 2" },
    { time: "10:00 PM", event: "Lightning talks" },
    { time: "11:00 PM", event: "Sponsor Talks?" },
