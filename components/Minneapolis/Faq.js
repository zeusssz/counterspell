...
const faqData = [
  ...
  },
  {
    ...
    answer: `We have run multiple events around the world. The summer of '21, we 
        <a href="https://www.youtube.com/watch?v=2BID8_pGuqA">chartered a train across America</a>
        and ran the world's longest hackathon on land. Last year, we ran an outdoors do-it-yourself <a href="https://www.youtube.com/watch?v=O1s5HqSqKi0">camping 
        adventure</a> in Cabot, Vermont.`,
  },
  {
    question: "I'm not good at coding, can I join?",
    answer: `This hackathon is for hackers, musicians, and artists of all skill levels! We'll have workshops and other events so join us and let's learn together. If you'd like to start exploring some introductory projects, check out <a href="https://workshops.hackclub.com/">Hack Club Workshops</a>.`,
  },
  {
  ...
  },
  {
    ...
    answer: `We're here to help! Ask them to reach out to us at
          <a href="mailto:counterspell@hackclub.com">counterspell@hackclub.com</a>,
          or for more Minneapolis-specific questions,
          here: <a href="mailto:counterspellminneapolis@gmail.com">counterspellminneapolis@gmail.com</a>.
          This includes questions about the venue and food.
  ...
  },
  {
    ...
    answer: `Contact us! Reach out at
          ...
          <a href="mailto:counterspell@hackclub.com">counterspell@hackclub.com</a>\n
          (or at <a href="mailto:counterspellminneapolis@gmail.com">counterspellminneapolis@gmail.com</a> for more Minneapolis-specific questions,
          including questions about the venue and food)
