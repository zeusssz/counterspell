...
import Hero from "../components/Phoenix/Hero";
import About from "../components/Phoenix/About";
import Guilds from "../components/Phoenix/Guilds";
import Steps from "../components/Phoenix/Steps";
import Locations from "../components/Phoenix/Locations";
import Faq from "../components/Phoenix/Faq";
import Footer from "../components/Phoenix/Footer";

// TODO: Change `Phoenix` to the name of your city
export default function Phoenix() {
  ...
  return (
    <>
      <Head>
        <title>Counterspell Phoenix</title>
      </Head>
      <div>
        <div
