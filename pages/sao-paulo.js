...
Make a copy of the example components (components/São Paulo) and rename it for your city.
...
// TODO: Change `São Paulo` to the name of your city. This should match the folder you copied!
import Hero from "../components/SaoPaulo/Hero";
import About from "../components/SaoPaulo/About";
import Guilds from "../components/SaoPaulo/Guilds";
import Steps from "../components/SaoPaulo/Steps";
import Locations from "../components/SaoPaulo/Locations";
import Faq from "../components/SaoPaulo/Faq";
import Footer from "../components/SaoPaulo/Footer";
...
export default function SaoPaulo() {
  ...
  return (
    <>
      <Head>
        {/* TODO: Change `São Paulo` to the name of your city */}
        <title>Counterspell São Paulo</title>
      </Head>
      <div>
        <div
